...
router.post('/', function(req, res) {
  ...
  pg.connect(connection, function(err, client, done) {
    ...
    var queryVar = 'INSERT INTO fms ' +
      ...
      'right_leg_forward, lunge_df, shoulder_mobility, left_top, right_top, l_impingment, r_impingment, shoulder_df, ' +
...
router.get('/:id', function(req, res) {
  ...
  pg.connect(connection, function(err, client, done) {
    ...
    var query = client.query('SELECT fms.deep_squat, fms.toe_touch, fms.deep_squat_df, fms.hurdle_step, fms.left_leg_up, fms.right_leg_up, fms.hurdle_df, fms.in_line_lunge, '+
      'fms.left_leg_forward, fms.right_leg_forward, fms.lunge_df, fms.shoulder_mobility, fms.left_top, fms.right_top, fms.l_impingment, fms.r_impingment, fms.shoulder_df, '+
